...
Observed: 2026-08-18T13:06:03+00:00
...
| x402 Bazaar | agent_native_demand_and_supply | ok | x402 Bazaar exposed 15,113 resources; the sampled records reported 53,605 calls and 13,423 unique-payer counts over 30 days. |
...
| GitHub public bounty demand | explicit_paid_work | ok | GitHub search returned 74,604 matching open issues; 0 sampled issues contained an explicit dollar bounty. |
| GitHub AI-agent buyer-language search | public_purchase_or_help_intent | ok | GitHub search returned 7,622 matching open issues; 1 sampled issues contained an explicit dollar bounty. |
| Recent Hacker News agent discussions | emerging_builder_attention_and_pain | ok | Recent Hacker News search returned 25 agent-related stories with 169 total points and 74 comments in the sample. |
...
- runtime_minutes: 0.048 used / 12 allowed
