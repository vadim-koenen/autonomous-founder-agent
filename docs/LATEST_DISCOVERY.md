...
Observed: 2026-07-25T14:00:43+00:00
...
| x402 Bazaar | agent_native_demand_and_supply | ok | x402 Bazaar exposed 14,281 resources; the sampled records reported 74,032 calls and 10,666 unique-payer counts over 30 days. |
...
- **Bazaar deployable MCP Registry agent/model pack**: Packaged, ready-to-deploy MCP Registry agent/model bundle listed as a resource on x402 Bazaar, enabling buyers to instantly deploy or call these tools. Buyer: Bazaar buyers seeking instantly usable agent/model packs (deployable tools).
...
- runtime_minutes: 0.4132 used / 12 allowed
