...
Observed: 2026-07-26T13:54:33+00:00
...
| x402 Bazaar | agent_native_demand_and_supply | ok | x402 Bazaar exposed 14,279 resources; the sampled records reported 74,015 calls and 10,570 unique-payer counts over 30 days. |
...
- **Bazaar Model & Docs Delta Alert Combo Demo**: Deploy a combo pack on x402 Bazaar: agent resource providing instant delta alerts and summaries on Roblox creator docs changes, powered by a reasoning model. Demo resource can be instantly called and paid for, fulfilling a concrete builder need. Buyer: x402 Bazaar native buyers (builders seeking tool/research agents).
